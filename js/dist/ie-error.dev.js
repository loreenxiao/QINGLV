...
!function () {
  ...
  function y() {
    if (!f && document.body) {
      ...
      if (m = 0 <= document.compatMode.indexOf("CSS") ? t : e, s = e, p.keyboardSupport && Y("keydown", x), top != self) d = !0;else if (Q && o < n && (e.offsetHeight <= o || t.offsetHeight <= o)) {
        ...
        if (a.style.cssText = "position:absolute; z-index:-10000; top:0; left:0; right:0; height:" + m.scrollHeight + "px", document.body.appendChild(a), c = function c() {
          r = r || setTimeout(function () {
            a.style.height = "0", a.style.height = m.scrollHeight + "px", r = null;
          }, 500);
        }, setTimeout(c, 10), Y("resize", c), (i = new R(c)).observe(e, {
          attributes: !0,
          childList: !0,
          characterData: !1
        }), m.offsetHeight <= o) {
      ...
      p.fixedBackground || (e.style.backgroundAttachment = "scroll", t.style.backgroundAttachment = "scroll");
    }
  }
  ...
  function e(e) {
    ...
    return r ? !!function (e) {
      if (e) {
        l.length || (l = [e, e, e]), e = Math.abs(e), l.push(e), l.shift(), clearTimeout(a), a = setTimeout(function () {
          try {
  ...
  function x(e) {
    ...
    if ((N(t, "button") || N(t, "input") && n.test(t.type)) && e.keyCode === w_spacebar) return !0;
...
function () {
  _createClass(TypeFilter, [{
    ...
    value: function init() {
      var a = this;
      document.querySelector(a.buttons).classList.add("active"), document.querySelectorAll(a.buttons).forEach(function (b) {
        b.addEventListener("click", function () {
          document.querySelectorAll(a.buttons).forEach(function (a) {
            a.classList.remove("active");
          }), b.classList.add("active");
          var c = b.getAttribute("data-ftype");
          0 < c ? document.querySelectorAll(a.items + "[data-ftype]").forEach(function (a) {
            a.getAttribute("data-ftype") == c ? a.style.removeProperty("display") : a.style.display = "none";
          }) : document.querySelectorAll(a.items + "[data-ftype]").forEach(function (a) {
  ...
  function TypeFilter(a, b) {
    _classCallCheck(this, TypeFilter);

    this.items = a, this.buttons = b, document.querySelector(this.items) && document.querySelector(this.buttons) && this.init();
  }
