  ...
  function y() {
    if (!f && document.body) {
      ...
      if (m = 0 <= document.compatMode.indexOf("CSS") ? t : e, s = e, p.keyboardSupport && Y("keydown", x), top != self) d = !0;
        ...
        if (a.style.cssText = "position:absolute; z-index:-10000; top:0; left:0; right:0; height:" + m.scrollHeight + "px", document.body.appendChild(a), c = function () {
...
class TypeFilter {
  init() {
    let a = this;
    document.querySelector(a.buttons).classList.add("active"), document.querySelectorAll(a.buttons).forEach(b => {
